...
Bien ya sabemos que podemos inyectar código JS y no podemos robar cookies de sección, entonces nuestro objetivo será visualizar el código fuente de  la pagina, par lo cual ocuparemos este script 
